...
## État actuel
- 2026-09-04 : le kit VibeObs v5.3 comprend `/create_projet`, les templates `rclone_backup` et `netlify`, ainsi qu’un contrôle mécanique de la base `DOCUMENTATION/` via `/doc_sync`.

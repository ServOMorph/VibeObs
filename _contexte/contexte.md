...
## État actuel
- 2026-09-06 : `roadmap_migration_close.md` achevée (3/3). `/update` rejoué sur Appli_TSA_SDI_TDAH (kit v3.1 → v5.4) : `create_memory.md` scopé par zone livré, `CLAUDE.md` fusionné sur le corps kit v5.4, `start.md`/`close.md` déjà byte-identiques (no-op). `DEPLOYMENTS.md` à jour (v5.4). Écart assumé : helper Ollama conservé dans `scripts/` côté projet.

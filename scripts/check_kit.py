...
KIT_ONLY_COMMANDS = {"cherche_meilleure_action.md", "create_agent.md", "create_com_agents.md", "create_parallel_team.md", "create_team.md", "doc_sync.md", "init_discord_mode.md", "create_projet.md"}
